...
window.ALMAIL.ar = {
  ...
  "member.viewPhoto": "عرض الصورة بالحجم الكامل",
  "media.prev": "الصورة السابقة",
  "media.next": "الصورة التالية",
  "gallery.view": "عرض بالحجم الكامل",
  "media.close": "إغلاق",
  "media.viewer": "صورة فوتوغرافية",
  "member.eyebrow": "الدليل",
  "member.all": "كل الأفراد",
  "member.role": "الصفة",
  "member.branch": "الفرع",
  "member.born": "الميلاد",
  "member.died": "الوفاة",
  "member.location": "مقر الإقامة",
  "member.share": "شارك هذا الملف",
  "member.nfTitle": "لم نعثر على هذا الشخص",
  "member.nfBody": "ربما أُعيدت تسمية الملف أو أُزيل. الدليل يضم كل من لدينا.",
  "member.nfCta": "العودة إلى الدليل",
  "directory.readMore": "اقرأ المزيد",
  ...
  /* --------------------------------------------------------------- contact */
  "contact.unconfigured": "نموذج المراسلة غير مفعّل بعد، لذلك لم تُرسل رسالتك. يرجى التواصل مع مجلس العائلة مباشرة.",
