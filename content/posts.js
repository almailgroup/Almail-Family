...
window.ALMAIL.posts = [
  {
    ...
    bodyAr: `
      ...
      <blockquote>ليست الإعلانات هي المقصد من الأمسية. المقصد أن يعرف الأطفال مئة وجه
      ما كانوا ليلتقوها إلا في العزاء.</blockquote>
  ...
  },
  {
    ...
    `,
    titleAr: "في قراءة الدفاتر القديمة: ماذا يخبرنا كُنّاش تاجر",
    excerptAr:
  ...
  },
  {
    ...
    authorAr: "فريق عمل الأرشيف",
    bodyAr: `
      <p class="lede">مختارات من الدفعة الثانية من الأفلام السالبة المُرقمَنة، تغطّي ما بين
      1961 و1969 تقريبًا.</p>

      <p>جاءت هذه اللقطات من علبة أحذية واحدة، بلا عناوين. وكان تأريخها جهدًا جماعيًا —
  ...
  },
  {
    ...
    bodyAr: `
      ...
      <ul>
        ...
        <li><strong>الخصوصية أصلًا.</strong> لا يُنشر شيء عن فرد حيّ من العائلة دون موافقته.</li>
